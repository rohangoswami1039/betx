...
import {View,Text,ScrollView,Button,TouchableOpacity,Linking,Dimensions,Image,StyleSheet,ProgressBarAndroid, Pressable} from 'react-native';
...
const noPercentage = 100 - yesPercentage;
    ...
    return (
        <View style={{flex: 1,flexDirection: 'column',paddingBottom:20,backgroundColor:'#181829'}}>
        <LoadingModal show={showLoadingModal}/>
       
        <ScrollView style={{backgroundColor:'#181829'}}>
        <View style={{flexDirection: 'row',marginLeft:28,marginRight:28,}}>
                <ArrowLeft style={{marginTop:30}} onPress={()=>navigation.navigate("Home")}/>
               
               
               <View style={{flexDirection: 'row', alignItems: 'center',  }}>
                <Text style={{textAlign:'center', color:'#ffff',marginTop:30, fontSize:20, fontFamily:'SourceSansPro', marginLeft:"40%"}}> Place a bet </Text>
            ...
            <View style={{
                ...
                // marginTop:20
                  ...
                  <Image source = {{uri:route.params.match.predictionImage}}
                        style = {{ 
            ...
            {/* <View> */}
            <View style={{ elevation:10, backgroundColor:'#222232',   margin:10, borderRadius:10, marginTop:-80, height:120,
    justifyContent: 'center',}}>
        <View style={{margin:10, padding:5}}>
           <Text style={{color:'#FFFFFF', fontSize:16, marginBottom:10, fontFamily: 'Segoe UI',  fontWeight: 'bold',}}>{route.params.match.heading}</Text>
           <Text style={{color:'#FFFFFF', fontSize:13, marginBottom:10, fontFamily: 'Segoe UI',}}>{route.params.match.description}</Text>
          </View>
            </View>
 
        <View style={{ elevation:10, backgroundColor:'#222232',  marginBottom:40, margin:10, borderRadius:10,}}>
        <View style={{margin:10, padding:5}}>
        <Text style={{color:'#FFFFFF', fontSize:10, marginBottom:10, fontFamily: 'Segoe UI',}}>WILL THIS PREDICTION COME TRUE?</Text>
     {/* </View> */}
       {!isVoted?  (   <>
                <Text style={{color:'#FFFFFF', fontSize:9, marginBottom:8, fontFamily: 'Segoe UI',}}>Vote to see the result</Text>
                <View style={{flexDirection:"row", }}>
                    <TouchableOpacity onPress={voteYes} style={{ backgroundColor: '#76A963', padding: 8, flex:1, marginRight: 10,}}>
                        <Text style={{color:"#FFFFFF", fontFamily: 'Segoe UI',}}>YES</Text>
                    </TouchableOpacity>

                    <TouchableOpacity onPress={voteNo} style={{ backgroundColor: '#F14C45', padding: 8, flex:1}}>
                        <Text style={{color:"#FFFFFF", fontFamily: 'Segoe UI',}}>No</Text>
                    </TouchableOpacity>

                </View>
               
                <Text style={{color:'#FFFFFF',marginTop:7, fontFamily: 'Segoe UI',}}>Total votes : {vote}</Text>
                </>
      ...
      />
        ...
        <Text style={{...styles.percentage, color:'#F14C45'}}>{noPercentage}%  </Text>
        <ProgressBarAndroid
        styleAttr="Horizontal"
        indeterminate={false}
        color="#F14C45"
...
<View style={{
            ...
            {route.params.match.matchDate.toDate() < (new Date()).setMinutes((new Date()).getMinutes()-10)?null:
            // <View style={{flexDirection: 'row', justifyContent: 'center' }}>

             <TouchableOpacity 
                onPress={ ()=>{ navigation.navigate('VideoAd')}} 
                style={{ height: 44, marginTop: 10,borderRadius:22 ,backgroundColor: '#EE775A' ,justifyContent: 'center', marginRight: 10}}>
                <Text style={{textAlign: 'center',fontSize:16,color: 'white'}}>How to place a bet ?</Text>
